              ...
              >
                <ResizablePanelGroup direction="vertical">
                  ...
                  {isAnimationMode && (
                    <>
                      <ResizableHandle />
                      {/* Animations / AI Generator Content */}
                      <ResizablePanel defaultSize={25} minSize={10}>
                        <Tabs defaultValue="animations" className="flex h-full flex-col">
                          <TabsList className="mx-2 mt-1.5 grid w-auto grid-cols-2 shrink-0">
                            <TabsTrigger value="animations" className="text-xs">Animations</TabsTrigger>
                            <TabsTrigger value="ai" className="text-xs">AI Generator</TabsTrigger>
                          </TabsList>
                          <TabsContent value="animations" className="flex-1 overflow-hidden mt-0">
                            <AnimationListPanel />
                          </TabsContent>
